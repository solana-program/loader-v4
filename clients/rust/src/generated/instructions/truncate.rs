...
pub const TRUNCATE_DISCRIMINATOR: u8 = 1;
...
impl Truncate {
    pub fn instruction(&self, args: TruncateInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.program, true));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
            self.authority,
            true,
        ));
        if let Some(destination) = self.destination {
            accounts.push(solana_instruction::AccountMeta::new(destination, false));
        } else {
            accounts.push(solana_instruction::AccountMeta::new_readonly(
                crate::LOADER_V4_ID,
                false,
